<template>
    <div class="text-center">
        ...
        <h2 class="text-primary pb-3">
            Current Score:{{ gameStore.getScore }}
        </h2>
        <span class="text-primary pb-3">
            Max Score: {{ gameStore.getWinningScore }}
        </span>
        <br>
        <span class="text-success pb-3 h3" v-if="gameStore.getScore>=gameStore.getWinningScore">
            You Won!
        </span>
        ...
        <br>
        <div class="row" v-if="gameStore.getScore<gameStore.getWinningScore &&gameStore.getScore>=0">
        ...
        <div v-else>
            <button class="form-control btn btn-primary p4" @click="gameStore.resetScore()">
                Reset Game
            </button>
        </div>
    </div>
